...
Crie uma função que receba uma lista de funcionários e retorne uma lista dos funcionários
que recebem salários de no mínimo 6200 e que sejam menores que 7200.
*/
...
const filtrarSalario = (funcionarios)=>{
    return funcionarios.filter(f =>  f.salario >= 6200 && f.salario <= 7200)
}
